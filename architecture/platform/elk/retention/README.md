...
Ces règles concernent les signaux de télémétrie et les journaux des VM architecture.
...
Prérequis : architecture active, quatre VM démarrées, accès SSH de l'inventaire Vagrant,
