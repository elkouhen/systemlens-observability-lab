...
collecteurs EDOT Kubernetes sont gérés par Fleet via OpAMP. Les VM
...
EDOT gérés par Fleet via OpAMP. Le Collector DaemonSet lit les logs stdout et les métriques hôte, puis les
...
d'enrôlement Fleet. Les VM utilisent exclusivement l'Elastic Agent Fleet
