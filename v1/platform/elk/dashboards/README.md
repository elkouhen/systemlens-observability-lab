...
| Santé de la collecte | Services Filebeat/Metricbeat de `data-01` et logs Logstash | métriques Beats et data streams `logs-*`/`metrics-*` | Services Filebeat/Metricbeat actifs sur `data-01`, erreurs d'input, débit d'événements et retards de collecte. |
...
Pour ce POC, PostgreSQL est attendu uniquement sur `data-01`.
