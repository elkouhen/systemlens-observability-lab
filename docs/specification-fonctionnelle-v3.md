# Spécification fonctionnelle v3

Cette spécification décrit les capacités attendues de la plateforme
d’observabilité v3 pour les applications Java, Kubernetes et les VM du POC.

| Élément | Définition |
| --- | --- |
| Nature | Spécification fonctionnelle de référence |
| Périmètre | Applications Java, workloads Kubernetes et VM de la v3 |
| Public | Product owner, développeurs, opérateurs et responsables de l’observabilité |
| Référence technique | [Spécification technique v3](specification-technique-v3.md) |
| Architecture | [Architecture v3](architecture-v3.md) |
...
- les évolutions d’une architecture v1 ou v2.

Ces sujets relèvent des documents applicatifs, de la
[spécification technique](specification-technique-v3.md) ou des README locaux.

## 6. Références

- [Architecture v3](architecture-v3.md) : topologie et invariants ;
