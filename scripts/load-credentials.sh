...
printf 'Identifiants chargés : ELASTICSEARCH_PASSWORD, KIBANA_PASSWORD, APM_SECRET_TOKEN, ELASTICSEARCH_API_KEY.\n'
unset _credentials_namespace _credentials_resolve _credentials_payload
