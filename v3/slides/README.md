# Présentation de l’architecture v3
...
Le contenu est aligné sur `v3/README.md`, `v3/platform/elk/README.md`, les
manifests Kustomize v3 et les templates Ansible du Gateway OTLP et de
l’exporteur Kafka.
