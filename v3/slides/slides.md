---
theme: default
title: Architecture v3 — Hybride Fleet
info: Présentation de l’architecture d’observabilité Elastic v3
class: text-center
highlighter: shiki
drawings:
  persist: false
...
- Kustomize : `v3/platform/kubernetes/` ;
- Ansible / Quadlet : `v3/ansible/` ;
- policy Fleet et dashboards : `v3/platform/elk/`.
...
make -C v3 ansible-validate
make -C v3 otel-validation
make -C v3 dashboards-verify
```
...
<div class="absolute bottom-8 right-10 text-sm opacity-70">Sources : v3/README.md · v3/platform/elk · v3/platform/kubernetes · v3/ansible</div>
