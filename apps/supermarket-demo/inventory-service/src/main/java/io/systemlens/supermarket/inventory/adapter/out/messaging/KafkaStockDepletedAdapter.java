...
import io.systemlens.supermarket.inventory.generated.event.StockDepleted;
...
class KafkaStockDepletedAdapter implements StockDepletedPort {
    ...
    public void publish(String productId, Instant occurredAt) {
        kafkaTemplate.send("supermarket.stock.depleted", productId,
            new StockDepleted(productId, occurredAt.atOffset(ZoneOffset.UTC)));
    }
}
